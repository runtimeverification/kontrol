...
class SolidityListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SolidityParser#PowExpression.
    def enterPowExpression(self, ctx:SolidityParser.PowExpressionContext):
        pass

    # Exit a parse tree produced by SolidityParser#PowExpression.
    def exitPowExpression(self, ctx:SolidityParser.PowExpressionContext):
        pass
