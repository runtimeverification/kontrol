...
def summary_to_account_cells(deployment_state_entries: Iterable[DeploymentStateEntry]) -> list[KApply]:
    accounts = _process_summary(deployment_state_entries)
...
def _process_summary(summary: Iterable[DeploymentStateEntry]) -> dict:
...
def _create_initial_account_list(program: KInner, summary: Iterable[DeploymentStateEntry] | None) -> list[KInner]:
